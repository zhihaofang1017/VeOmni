...
@MODEL_CONFIG_REGISTRY.register("qwen3_moe_foundation")
def register_qwen3_moe_foundation_config():
    ...
    return Qwen3MoeFoundationConfig


@MODELING_REGISTRY.register("qwen3_moe_foundation")
def register_qwen3_moe_foundation_modeling(architecture: str):
    from .modeling_qwen3_moe_foundation import Qwen3MoeFoundationModel

    return Qwen3MoeFoundationModel
