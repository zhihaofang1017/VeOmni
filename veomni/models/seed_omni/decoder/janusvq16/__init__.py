...
@MODEL_CONFIG_REGISTRY.register("janusvq16_decoder")
def register_janus_config():
    from .configuration_janusvq16 import JanusVQ16DecoderConfig

    return JanusVQ16DecoderConfig


@MODELING_REGISTRY.register("janusvq16_decoder")
def register_janus_modeling(architecture: str):
    from .modeling_janusvq16 import JanusVQ16Decoder

    return JanusVQ16Decoder


@MODEL_PROCESSOR_REGISTRY.register("JanusVQ16DecoderProcessor")
def register_janusvq16_processor():
    from .processing_janusvq16 import JanusVQ16DecoderProcessor

    return JanusVQ16DecoderProcessor
