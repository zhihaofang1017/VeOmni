...
@MODEL_CONFIG_REGISTRY.register("instruct_pix2pix")
def register_instruct_pix2pix_config():
    from .configuration_instruct_pix2pix import InstructPix2PixConfig

    return InstructPix2PixConfig


@MODELING_REGISTRY.register("instruct_pix2pix")
def register_instruct_pix2pix_modeling(architecture: str):
    from .modeling_instruct_pix2pix import InstructionPix2Pix

    return InstructionPix2Pix
