...
@MODEL_CONFIG_REGISTRY.register("qwen2_5_vl_vision_model")
def register_qwen2_5_vl_vision_model_config():
    from .configuration_qwen2_5_vl_vision_model import Qwen25VLVisionModelConfig

    return Qwen25VLVisionModelConfig


@MODELING_REGISTRY.register("qwen2_5_vl_vision_model")
def register_qwen2_5_vl_vision_model_modeling(architecture: str):
    from .modeling_qwen2_5_vl_vision_model import Qwen25VLVisionModel

    return Qwen25VLVisionModel


@MODEL_PROCESSOR_REGISTRY.register("Qwen25VLVisionModelProcessor")
def register_qwen2_5_vl_vision_model_processor():
    from .processing_qwen2_5_vl_vision_model import Qwen25VLVisionModelProcessor

    return Qwen25VLVisionModelProcessor
