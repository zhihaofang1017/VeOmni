...
def apply_qwen2_npu_patch():
    # Patches for Qwen2 Model
    hf_qwen2.apply_rotary_pos_emb = npu_fused_operator.apply_rotary_pos_emb_npu
    hf_qwen2.Qwen2RMSNorm.forward = npu_fused_operator.rms_norm_forward_npu
