...
class DeepseekV3MoE(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.experts = DS_V3_MOE_CLASSES[config._moe_implementation](config)
...
class DeepseekV3ForCausalLM(DeepseekV3PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        # Modification: we add causallm_loss_function here
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # originally we compute the logits directly here
