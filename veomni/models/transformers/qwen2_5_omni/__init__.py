...
def register_qwen2_5_omni_config():
    ...
    # lm_head, so post-load embedding tying must be a no-op. Applied on both
    # v4 and v5 branches — upstream HF keeps the default True, which would
    # drive post_process_after_weight_loading into an unresolvable
    # get_input_embeddings fallback. See configuration_qwen2_5_omni.py for the
    # full rationale.
