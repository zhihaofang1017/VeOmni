...
from ....ops.gpt_fused_moe import fused_moe_forward
    ...
    def forward(self, hidden_states: torch.Tensor, router_indices=None, routing_weights=None) -> torch.Tensor:
        ...
        if self.training:
            if self.moe_implementation == "eager":
                routing_weights = hidden_states.new_zeros((hidden_states.shape[0], num_experts)).scatter_(1, router_indices, routing_weights)
            ...
            elif self.moe_implementation == "fused":
...
class GptOssMLP(nn.Module):
    ...
    def forward(self, hidden_states):
        router_top_value, router_indices = self.router(hidden_states)  # (num_experts, seq_len)
        routed_out = self.experts(hidden_states, router_indices=router_indices, routing_weights=router_top_value)
        return routed_out, router_top_value
